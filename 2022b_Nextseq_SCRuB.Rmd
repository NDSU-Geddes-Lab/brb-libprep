---
title: "2022b NextSeq SCRuB of Plates 1-4"
author: "Brooke Benz"
date: "2024-05-15"
output:
...
path <- "/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB"

# load merged phyloseq object 
ps_22b <- readRDS("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/Merging PS Objects/2022b_trim251.ps.rds")
ps_22b
```
...
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p1.RData")
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p2.RData")
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p3.RData")
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p4.RData")
```
...
#decon_p1 <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_ScrubDecontaminatedSamples_p1_pcr.csv", row.names = 1) %>% as.matrix()
#decon_p2 <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_ScrubDecontaminatedSamples_p2_pcr.csv", row.names = 1) %>% as.matrix()
#decon_p3 <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_ScrubDecontaminatedSamples_p3_pcr.csv", row.names = 1) %>% as.matrix()
#decon_p4 <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_ScrubDecontaminatedSamples_p4_pcr.csv", row.names = 1) %>% as.matrix()
```
...
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p1_ex.RData")
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p2_ex.RData")
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p3_ex.RData")
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p4_ex.RData")
```
...
#decon_p1_ex <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_ExNegCtrl_ScrubDecontaminatedSamples_p1.csv", row.names = 1) %>% as.matrix()
#decon_p2_ex <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_ExNegCtrl_ScrubDecontaminatedSamples_p2.csv", row.names = 1) %>% as.matrix()
#decon_p3_ex <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_ExNegCtrl_ScrubDecontaminatedSamples_p3.csv", row.names = 1) %>% as.matrix()
#decon_p4_ex <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_ExNegCtrl_ScrubDecontaminatedSamples_p4.csv", row.names = 1) %>% as.matrix()
```
...
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p1_comb.RData")
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p2_comb.RData")
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p3_comb.RData")
load("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/scrubOut_p4_comb.RData")
```
...
#decon_p1 <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_combNegCtrl_ScrubDecontaminatedSamples_p1.csv", row.names = 1) %>% as.matrix()
#decon_p2 <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_combNegCtrl_ScrubDecontaminatedSamples_p2.csv", row.names = 1) %>% as.matrix()
#decon_p3 <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_combNegCtrl_ScrubDecontaminatedSamples_p3.csv", row.names = 1) %>% as.matrix()
#decon_p4 <- read.csv("/Users/brookeb/Documents/R/Final Codes/2022/2022_Nextseq/SCRuB/2022b_combNegCtrl_ScrubDecontaminatedSamples_p4.csv", row.names = 1) %>% as.matrix()
```
